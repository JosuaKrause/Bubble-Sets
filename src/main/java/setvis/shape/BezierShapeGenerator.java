...
public class BezierShapeGenerator extends RoundShapeGenerator {
   ...
   *          clockwise order.
   * @param hasMaxRadius Whether there should be a maximal radius for the
   *          curves.
   */
  public BezierShapeGenerator(final SetOutline outline,
   ...
   * @param left The point left of the current point.
   * @param right The point right of the current point.
   ...
   * Getter.
   * 
   * @return Whether a maximal radius will be used.
   */
  ...
  /**
   * Creates bezier points by going a certain radius away from the current point
   * in the directions of the neighbors.
   * 
   * @param point The current point.
   * @param left The point left of the current point.
   * @param right The point right of the current point.

...
public class BubbleSet implements SetOutline {
    ...
    public static final int NO_DOUBLE_EDGES = 0x01;

    public static final int FULL_EXTEND_EDGES = 0x02;

    public static final int FAST_EXACT_EDGES = 0x00;

    public static final int LEAST_CONNECTED_FULL_EDGES = NO_DOUBLE_EDGES
            | FULL_EXTEND_EDGES;

    private int edgeCreationBitMask = LEAST_CONNECTED_FULL_EDGES;
    ...
    public void setEdgeCreationBitMask(final int edgeCreationBitMask) {
        this.edgeCreationBitMask = edgeCreationBitMask;
    }

    public int getEdgeCreationBitMask() {
        return edgeCreationBitMask;
    }

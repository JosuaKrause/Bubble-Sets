...
public interface Canvas {
   ...
   * 
   * @param listener The listener to add. If it is <code>null</code> an
   *          {@link NullPointerException} is thrown.
   */
  void addCanvasListener(CanvasListener listener);

  /**
   * Removes a canvas listener.
   * 
   * @param listener The canvas listener to remove.
   */
   ...
   * 
   * @param changes The changes as defined in {@link CanvasListener}.
   */
   ...
   * 
   * @param outline The outline generator.
   * @param shapeType The shape generator type.
   */
   ...
   * 
   * @param outlineType The outline generator type.
   * @param shapeType The shape generator type.
   */
   ...
   * Setter.
   * 
   * @param shaper Directly sets the shape generator.
   */
   ...
   * Setter.
   * 
   * @param drawPoints Whether to draw control points.
   */
   ...
   * Setter.
   * 
   * @param tolerance Sets the tolerance for simplification.
   * @see ShapeSimplifier
   */
   ...
   * 
   * @param curItemGroup The new group id.
   */
   ...
   * 
   * @param curItemWidth The new width.
   */
   ...
   * 
   * @param curItemHeight The new height.
   */
   ...
   * @param tx The x position in component coordinates.
   * @param ty The y position in component coordinates.
   ...
   * 
   * @param tx The x value in component coordinates.
   * @param ty The y value in component coordinates.
   ...
   * 
   * @param x The x value in component coordinates.
   * @param y The y value in component coordinates.
   */
   ...
   * 
   * @param pos The identifier for the item.
   * @param dx The translation on the x axis.
   * @param dy The translation on the y axis.
   */

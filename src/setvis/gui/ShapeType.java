...
public enum ShapeType {
  ...
  /** Cardinal Spline shape generator. */
  CARDINAL("Cardinal Splines", CardinalSplineGenerator.class),

  /** Kochanek-Bartels Spline shape generator. */
   ...
   *          from {@link AbstractShapeGenerator} objects.
   */
  ...
  /** The lookup map. */
  private static final Map<Class<?>, ShapeType> MAP =
      new HashMap<Class<?>, ShapeType>();
   ...
   * 
   * @param shaper The shape generator object to find the type for.
  ...
  /**
   * Generates the java constructor text.
   * 

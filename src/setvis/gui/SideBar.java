...
public class SideBar extends JPanel {
   ...
   * Getter.
   * 
   * @return Gets the group count of the canvas.
   */
  ...
  protected class CanvasListModel extends AbstractListModel {
    ...
    public void invalidate() {
      fireContentsChanged(this, 0, getGroupCount());
    }
   ...
   * 
   * @param changes The type of changes as defined in
   ...
   * 
   * @param outlineType The current outline type.
   * @param so The current set outline.
   */
